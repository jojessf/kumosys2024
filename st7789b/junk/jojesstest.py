...
sys.path.append("/home/jojess/st7789b") # lib/ and Font/  ;3
...
try:    
    ...
    while 1==1:
        ...
        draw.text((0, 42),u"天氣> ", fill = "PURPLE", font=Font3)
        draw.text((50,42), tenkiStr, fill = "PURPLE", font=Font4)
        draw.text((0, 82), "AQI> ", fill = "PURPLE", font=Font3)
        draw.text((50, 82), aqiStr, fill = "MAGENTA", font=Font5)
        # draw.text((0, 122), "uwu> ", fill = "RED", font=Font3)
